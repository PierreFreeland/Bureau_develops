...
class ConsultantAccountsInfosTest < GoxygeneSetUp
  setup do
    visit goxygene.consultant_infos_accounts_path(Goxygene::Consultant.find(8786))
    assert_selector "h4", text: "COMPTA"
  end
  ...
  test "Should export excel" do
    ...
    sleep 2
    full_path = DOWNLOAD_PATH+"/financial_accounting_entries.xlsx"
